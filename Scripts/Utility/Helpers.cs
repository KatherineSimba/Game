...
namespace Gamekit2D
{
    ...
    public static class PlatformerEffector2DExtension
    {
        public static bool ValidCollision(this PlatformEffector2D effector, Vector2 velocity)
        {
            ...
            //redondeamos tanto el punto como el cos a una precisión de 1/1000 para evitar un comportamiento indefinido en la caja del borde (por ejemplo, el lado de una plataforma con un arco lateral de 180)
